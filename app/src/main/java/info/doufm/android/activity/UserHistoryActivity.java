...
public class UserHistoryActivity extends ActionBarActivity {
    ...
    private void getMoreHistory() {
        JsonArrayRequestWithCookie jsonArrayRequestWithCookie = new JsonArrayRequestWithCookie(NetworkConstans.USER_MUSIC_URL + "?type=listened&start=" + String.valueOf(startId) + "&end=" + String.valueOf(startId + num), new Response.Listener<JSONArray>() {
            @Override
...
/*                    realm.commitTransaction();
        ...
        RequestManager.getRequestQueue(this).add(jsonArrayRequestWithCookie);
    }
